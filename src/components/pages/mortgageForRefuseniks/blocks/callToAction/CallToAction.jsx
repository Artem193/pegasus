  ...
  return (
    <div className="callToAction">
      <div className="callToAction__textContent">
        ...
        <h2 className="callToAction__subtitle">
          <span className="color-yellow">Бесплатная консультация: </span><a href="tel:972545991090" className="callToAction__link">054-5991090 <a href="https://wa.me/972545991090" className="callToAction__link" target="_blank">(WhatsApp)</a></a>, работаем 24/7
        </h2>
      </div>
      <CallToActionForm />
    </div>
